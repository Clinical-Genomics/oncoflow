...
- [#18](https://github.com/Clinical-Genomics/oncoflow/pull/18) Added `linx_fusion_tsv`, `linx_breakends_tsv` and `linx_sv_tsv` parameters to `getOncorefinerParamsList`.
