...
- [#3](https://github.com/Clinical-Genomics/oncoflow/pull/3) Added `NFCORE_ONCOANALYSER` using the `NEXTFLOW_RUN` local module to run the `Clinical-Genomics/oncoanalyser` pipeline in `ONCOFLOW` workflow.
