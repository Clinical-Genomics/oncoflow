...
# `Clinical-Genomics/oncoflow`: Contributing Guidelines

Hi there!
Many thanks for taking an interest in improving Clinical-Genomics/oncoflow.

We try to manage the required tasks for Clinical-Genomics/oncoflow using GitHub issues, you probably came to this page when creating one.
...
- [General](#general)
  ...
  - [Adding citations](#adding-citations)
    ...
    - [2. `subworkflows/local/utils_nfcore_oncoflow_pipeline/main.nf`](#2-subworkflowslocalutils_nfcore_oncoflow_pipelinemainnf)
...
If you'd like to write some code for Clinical-Genomics/oncoflow, the standard workflow is as follows:

1. Check that there isn't already an issue about your idea in the [Clinical-Genomics/oncoflow issues](https://github.com/Clinical-Genomics/oncoflow/issues) to avoid duplicating work. If there isn't one already, please create one so that others know you're working on this
2. [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [Clinical-Genomics/oncoflow repository](https://github.com/Clinical-Genomics/oncoflow) to your GitHub account
...
- Open the repo in [Codespaces](https://github.com/Clinical-Genomics/oncoflow/codespaces)
- Tools installed
  - nf-core
  - Nextflow
...
#### 2. `subworkflows/local/utils_nfcore_oncoflow_pipeline/main.nf`
...
To make the `Clinical-Genomics/oncoflow` code and processing logic more understandable for new contributors and to ensure quality, we semi-standardise the way the code and other contributions are written.

### Architecture & structure

- **Use subworkflows** — Don't add logic to `workflows/oncoflow.nf` that is specific to a subworkflow. Create new subworkflows as needed under `subworkflows/` and import them into `workflows/oncoflow.nf`.
