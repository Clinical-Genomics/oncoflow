# Clinical-Genomics/oncoflow pipeline parameters
...
| `oncoanalyser_create_stub_placeholders` | Create placeholders for reference data during stub run. | `boolean` | False |  |  |
| `oncoanalyser_genome` | Name of genome reference. | `string` |  |  |  |
| `oncoanalyser_mode` | Workflow run mode. | `string` |  |  |  |
